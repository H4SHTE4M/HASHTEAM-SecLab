...
__attribute__((naked, used)) void pop_eax_ret(void) {
    __asm__ volatile("pop %eax; ret");
}

__attribute__((naked, used)) void check_eax(void) {
    __asm__ volatile(
        "cmpl $0x4b434154, %eax\n"
        "jne 1f\n"
        "movl $4, %eax\n"
        ...
        "int $0x80\n"
        ".pushsection .rodata\n"
        "marker: .ascii \"PwnHub ROP gadget complete\\n\"\n"
        ".popsection\n");
}
